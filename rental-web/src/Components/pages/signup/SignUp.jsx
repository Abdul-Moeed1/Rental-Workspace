    ...
    return (
        <div className="signup-page-container w-full h-screen flex bg-blue-950 px-2">
            ...
            <div className="signup-page m-auto  rounded-lg bg-white px-12 py-6 w-[400px]  ">
                ...
                <form onSubmit={handleSubmit} className="signup-form mt-6">
                    ...
                    <div className="signup-form-input flex gap-3 border-b py-2 mb-3">
                        ...
                        <input type="text" name="name" id="name" placeholder="Enter your name" required
                            value={formData.name}
                            onChange={handleChange} className="focus:outline-none w-full" />
                    </div>
                    ...
                    {emailDup && (<small className="text-red-700 mt-1 block">
                    ...
                    <div className="signup-form-input flex gap-3 border-b py-2 mb-3">
                        ...
                        onChange={handleChange}
                        required className="focus:outline-none w-full" />
                    </div>
